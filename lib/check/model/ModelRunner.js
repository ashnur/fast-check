...
/** @hidden */
var internalAsyncModelRun = function (s, cmds) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                runAsync = function (cmd, m, r) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, cmd.check(m)];
                            case 1:
                                if (!_a.sent()) return [3 /*break*/, 3];
                                return [4 /*yield*/, cmd.run(m, r)];
                            case 2:
                                _a.sent();
                                _a.label = 3;
                ...
                return [4 /*yield*/, genericModelRun(setupProducer, cmds, Promise.resolve(), runAsync, then)];
 ...
 */
exports.asyncModelRun = function (s, cmds) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, internalAsyncModelRun(s, cmds)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
