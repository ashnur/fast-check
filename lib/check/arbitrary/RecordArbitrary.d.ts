...
declare type ConstrainedArbitrary<T, Constraints> = Constraints extends DeletedKeys | DeletedKeysDepreciated | DeleteConditions ? Arbitrary<Partial<T>> : Arbitrary<T>;
/**
